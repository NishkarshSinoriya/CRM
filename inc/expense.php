...
<div class="container-fluid">
  ...
  <div class="col-sm-11">
    <div class="card">
      <form class="" action="expense.php" method="get">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <ul>
                ...
                <div class="box">
                  <?php
                   if (isset($_GET['date1']))
                   {
                     ...
                     $date1=$_GET['date1'];
                     $date2=$_GET['date2'];
                     $sql="SELECT sum(expanse) FROM expanse WHERE date BETWEEN '$date1' AND '$date2'";
                  ...
                  <div class="row">
                    <div class="wrap">
                      ...
                      <div class="col-sm-3 col-sm-offset-9">
                        <h4>total expense -  <span><?php echo $row['sum(expanse)'] ?></span> </h4>
                      </div>
                    </div>
                  </div>
                  </div>
